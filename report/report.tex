...
Because when a variable $v$ has reached the value 157 after $T$ steps, in subsequent steps, the SMT-solver can always pick a variable that does not have the value 157.
