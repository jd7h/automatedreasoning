...
\texttt{W(i)} = width$(s_i)$ and \texttt{H(i)} = height$(s_i)$ or 
\texttt{W(i)} = height($s_i)$ and \texttt{W(i)} = width($s_i)$:

\[ \bigwedge_{1<i<n} 
\texttt{W(i)} = \text{width}(s_i) \wedge \texttt{H(i)} = \text{height}(s_i) \oplus
\texttt{W(i)} = \text{height}(s_i) \wedge \texttt{W(i)} = \text{width}(s_i)
\]
...
\texttt{X(i)} >= 0 \wedge
\texttt{Y(i)} >= 0 \wedge
\texttt{X(i)}+\texttt{W(i)} <= b \wedge
\texttt{Y(i)}+\texttt{H(i)} <= b
\]
